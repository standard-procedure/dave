...
module Dave
  module XML
    ...
    def self.build_propstat_node(doc, dav_ns, prop_hash, status_code)
    ...
    def self.find_or_create_ns_prefix(node, ns_uri)
    ...
    def self.set_node_value(el, value, dav_ns, doc)
    ...
    def self.import_node(source_node, target_doc, dav_ns)
    ...
    def self.rebind_dav_namespace(node, dav_ns)
